...
questions_list.append(Question('приве','о','к','д','т'))
questions_list.append(Question('-_-','_-_','о_о','xD','оэ'))
questions_list.append(Question('a','1','2','3','4'))
questions_list.append(Question('-_-','_-_','о_о','xD','оэ'))
questions_list.append(Question('при','d','к','д','т'))
questions_list.append(Question('-_-','_-6','о_о','xD','оэ'))
